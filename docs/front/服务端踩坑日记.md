...
![云主机控制台](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/云主机控制台.png)  
...
![检查钥匙](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/检查钥匙.png)  
...
![用户权限配置](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/用户权限配置.png)  
...
![修改端口](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/修改端口.png)  
...
还是同样的配置文件，修改地方如下：  
![修改登录权限](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/修改登录权限.png)  
...
![iptables配置1](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/iptables配置1.png)
![iptables配置2](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/iptables配置2.png)
...
这家伙的作用如图：  
![Nginx作用](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/Nginx作用.png)
...
![Nginx自定义配置](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/Nginx自定义配置.png)
...
![域名信息](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/域名信息.jpg)

这里介绍一下上面利用CNAME来映射七牛云：  
首先进入七牛云控制台，点击右侧自定义域名。  
![七牛云映射](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/七牛云映射.jpg)
填写 `加速域名` 为腾讯云中添加的二级域名(xx.kokota.cn)，其他选项选默认就好。  
然后我们从七牛云中进入这个新加的域名，点击右侧 `如何配置CNAME`。  
![七牛云映射2](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/七牛云映射2.jpg)
复制该位置粉色字体后面的地址，这个地址就是CNAME解析时的地址。  
![七牛云映射3](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/七牛云映射3.jpg)
然后将该值添加到对应的二级域名的记录值中即可。  
![七牛云映射4](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/七牛云映射4.jpg)
...
然后通过以下代码格式创建一个管理员:  
![创建管理员](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/创建管理员.jpg)
创建成功后我们使用 `db.auth(用户名，密码)` 的形式进行授权操作，返回值为 1 说明授权成功，现在我们的身份就是管理员了。  

然后我们以这个身份切换到别的数据库来创建角色。  
通过以下代码格式创建角色：  
![创建角色](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/创建角色.jpg)
...
![打开验证模式](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/打开验证模式.jpg)
然后重启数据库来更新配置。  
...
![自动备份脚本](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/自动备份脚本.jpg)
写完脚本后我们可以输入 `sh ./tasks/talk.backup.sh` 来执行脚本，执行后检查是否有数据压缩包。  

OK，脚本写好了，现在我们要让它每过一段时间执行一次。  
通过 `crontab -e` 打开系统任务配置文件。  
添加时间任务如下：  
![时间任务](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/时间任务.jpg)
...
![七牛云上传文件](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/七牛云上传文件.jpg)
这样我们就可以将压缩包上传到七牛云的存储空间了。  

**PS**：上传到七牛云时，七牛云需要创建对应的存储空间。  
**PS**：除了安装 MongoDB，也可以安装 Mysql。  
![安装mysql](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/安装mysql.jpg)
...
![MongoDB连接](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/MongoDB连接.jpg)
...
跟着党走，配置后的信息如下：  
![stream模块配置](https://qcloudtest-1256171877.cos.ap-guangzhou.myqcloud.com/blog/images/server-build/stream模块配置.jpg)  
完成！  
